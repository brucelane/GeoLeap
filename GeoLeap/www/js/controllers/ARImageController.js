    ...
    function (
      ...
      LocationsService
        ...
        $scope.$on("$ionicView.loaded", function (e) {
            setTimeout(function () {
                // canvas2d
                $scope.canvas = angular.element(document.getElementById('canvas2d'));
        ...
        function createModel1() {
            ...
            var material = new THREE.MeshBasicMaterial({ map: textureVideo });
        ...
        function createModel3() {
            var object = new THREE.Object3D();
            var geometry = new THREE.BoxGeometry(boxWidth, boxHeight, boxDepth);
            var texture = THREE.ImageUtils.loadTexture("img/batiments/logo-casa.png");//eilen3.jpg");
            var material = new THREE.MeshBasicMaterial({ map: texture });
            var mesh = new THREE.Mesh(geometry, material);
...
*/
            ...
            if (translation[0] > 0) {
                //if (newFound) {
                    ...
                    object.position.y = translation[1];
                /*} else {
                    if (object.position.x < translation[0]) { object.position.x += ( translation[0] - object.position.x ) / 2; } else { object.position.x += ( object.position.x - translation[0] ) / 2; };
                    if (object.position.y < translation[1]) { object.position.y += (translation[1] - object.position.y) / 2; } else { object.position.y -= (object.position.y - translation[1]) / 2; };
                    //if (object.position.z < -translation[2]) { object.position.z += (-translation[2] - object.position.z) / 2; } else { object.position.z -= (object.position.z - translation[2]) / 2; };
                }*/
                object.position.z = -translation[2];
            }
        };
